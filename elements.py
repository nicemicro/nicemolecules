...
class Element:
    ...
    Members:
        symbol: str, the chemical symbol of an atom
        valence_el: int, number of valence electrons
        fullshell: int, the number of electrons in a filled valence shell
        hypervalent: bool, whether the atom can accomodate more electrons
